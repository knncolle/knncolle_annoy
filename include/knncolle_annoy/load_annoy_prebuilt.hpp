 ...
 * This should be the same as the distance reported in `PrebuiltSaveConfig::distance`.
 * @tparam AnnoyIndex_ Integer type for the observation indices in the Annoy index.
 * This should be the same as the type reported by `PrebuiltSaveConfig::index`.
 * @tparam AnnoyData_ Floating-point type for data in the Annoy index.
 * This should be the same as the type reported by `PrebuiltSaveConfig::data`.
